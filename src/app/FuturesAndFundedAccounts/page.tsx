...
const fundedCompanies: FundedCompany[] = [
  ...
  {
    name: 'AquaFuture',
    description: 'تقدم AquaFuture مسارات تمويل مرنة للمتداولين، مع خيارات متنوعة تناسب المبتدئين والمحترفين على حد سواء، وتركز على إدارة المخاطر الذكية.',
    highlight: 'جديد',
    logo: '/img/aquafuture.svg',
    url: 'https://www.aquafuture.com/',
    consistencyRequirement: '45%',
    generalRules: [
      'برامج تقييم مصممة لاختبار قدرتك على تحقيق أهداف ربح مع الالتزام بقواعد المخاطرة.',
      'خياران رئيسيان: حسابات باشتراك شهري (Beginner) وحسابات بتفعيل لمرة واحدة (Advanced).',
      'يجب التداول في 5 أيام على الأقل في حسابات Beginner.',
      'لا يوجد حد أدنى لأيام التداول في حسابات Advanced.',
      'حد الخسارة اليومي والحد الأقصى للتراجع يختلفان بناءً على الخطة المختارة.',
    ],
    plans: [
      {
        name: 'Beginner 25K (بدون تفعيل)',
        metrics: [
          { label: 'هدف الربح', value: '$1,500' },
          { label: 'الحد الأقصى للخسارة', value: '$1,500 Trailing' },
          { label: 'الحد الأقصى للعقود', value: '3 عقود' },
          { label: 'الاشتراك الشهري', value: '$45' },
        ],
        priceNote: 'إعادة ضبط الحساب متاحة بنفس قيمة الاشتراك.',
      },
      {
        name: 'Advanced 50K (مع تفعيل)',
        metrics: [
          { label: 'هدف الربح', value: '$3,000 (6%)' },
          { label: 'حد الخسارة الإجمالي', value: '$2,000 (4%)' },
          { label: 'رسوم التفعيل', value: '$95 لمرة واحدة' },
          { label: 'الاحتفاظ الليلي/عطلة', value: 'غير مسموح' },
        ],
        priceNote: 'رسوم تفعيل تدفع مرة واحدة فقط.',
      },
    ],
    extraNotes: [
      'حصة الأرباح تبدأ من 80% وتصل إلى 90% للمتداولين الممولين.',
      'بعد النجاح في التقييم، يتم الانتقال إلى حساب ممول بنفس حجم حساب التقييم.',
    ],
  },
  {
    name: 'Earn2Trade',
