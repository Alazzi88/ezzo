...
const fundedCompanies: FundedCompany[] = [
  ...
  {
    name: 'Earn2Trade',
    description: 'خضنا تقييم Gauntlet Mini لديهم ويُعد خياراً مناسباً لمن يفضل خطة تدرج واضحة وتدريباً عملياً أثناء الاختبار.',
    highlight: 'تم اختبارها بنجاح',
    logo: '/img/earn2trade.webp',
    url: 'https://earn2trade.com/',
    consistencyRequirement: '30%',
    generalRules: [
      'يجب التداول على الأقل في 10 أيام مع الالتزام بسلم العقود (Progression Ladder).',
      'الخسارة المتحركة تبدأ من الرصيد الابتدائي وتتحرك مع كل قمة ربحية حتى تصل إلى الحد الثابت للحساب الحي.',
      'التداول مسموح فقط خلال الأوقات المعتمدة، ويجب الحذر من الأخبار عالية التأثير التي قد توقف التقييم.',
      'لا توجد رسوم إعداد مسبقة، وتتوفر إعادة تعيين مجانية عند دفع الاشتراك التالي.',
    ],
    plans: [
      {
        name: 'حساب 25K',
    ...
    extraNotes: [
      'بعد اجتياز Gauntlet Mini ينتقل المتداول إلى حساب LiveSim ثم حساب حي مع حصة أرباح تبدأ من 80% وترتفع مع الأداء.',
    ],
  },
  {
    name: 'FundedNext',
