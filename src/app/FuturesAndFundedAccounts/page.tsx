      ...
      <div className="page-shell">
        ...
        <ScaleIn delay={0.2}>
          <div className="relative overflow-hidden rounded-3xl border border-orange-500/20 bg-gradient-to-br from-orange-500/10 via-black/60 to-amber-500/10 px-6 py-10 text-center">
            ...
            <div className="mt-4 inline-flex items-center gap-2 rounded-full border border-blue-400/30 bg-blue-500/10 px-4 py-1.5 text-xs font-medium text-blue-300">
              ...
              التواصل للفيوتشر والحسابات الممولة مباشرة — البوت مخصص للأوبشن فقط
            </div>
