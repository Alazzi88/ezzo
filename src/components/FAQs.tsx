...
const FAQs: React.FC = () => {
  ...
  const faqData: FAQItem[] = [
    ...
    },
    {
      ...
      answer:
        "يعمل مؤشر إيزو على مختلف الفريمات الزمنية (مثل الدقيقة، 5 دقائق، 15 دقيقة...). اختيار الفريم المناسب يعتمد على أسلوبك في التداول، فإذا كنت مضاربًا قصير الأجل قد يناسبك فريم الدقيقة أو الـ 5 دقائق، بينما يُفضّل فريم الـ 15 دقيقة للمتداولين متوسطي الأجل.",
    },
    {
