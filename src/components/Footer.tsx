...
const socialLinks = [
  ...
  { icon: <FaYoutube size={22} />, url: 'https://www.youtube.com/@Ezzo3zzo', color: 'from-red-600/80 via-rose-500/80 to-orange-500/80' },
...
const navigationLinks = [
  ...
  { label: 'الأوبشن الأمريكي', href: '/Optiontrading' },
      ...
      <div className="page-shell">
        <div className="glass-panel overflow-hidden px-6 py-10 sm:px-10">
          ...
          <div className="flex flex-col gap-4 text-xs text-gray-400 sm:flex-row sm:items-center sm:justify-between">
            ...
            <p>صُمم بعناية لدعم المتداولين الطموحين في أسواق الفيوتشر والأوبشن.</p>
          </div>
        </div>
      </div>
    </footer>
